...
public class Quiz06_JavaMethod {
	...
	private static int findJava(String java) {
		return java.split("Java",-1).length -1;
	}
	public static void main(String[] args) {

		// 자바의 String 이 가지고 있는 내장함수를 이용해야 함 
		// String 참조변수에 . 찍었을 때 나오는 메서드 목록을 살펴보면서 아래의 문제들을 풀 수 있는 메서드를 찾아보고
		// countA, countChar, findJava 메서드 정의부를 완성해 에러가 나지 않도록 완성시키기!
